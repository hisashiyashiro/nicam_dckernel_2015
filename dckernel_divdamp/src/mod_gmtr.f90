module mod_gmtr
  ...
  !cx   real(RP), public, allocatable, save :: GMTR_P_var   (:,:,:,:)
  !cx   real(RP), public, allocatable, save :: GMTR_T_var   (:,:,:,:,:)
  !cx   real(RP), public, allocatable, save :: GMTR_A_var   (:,:,:,:,:)

  real(RP), public, allocatable, save :: GMTR_P_var_pl(:,:,:,:)
  real(RP), public, allocatable, save :: GMTR_T_var_pl(:,:,:,:)
  real(RP), public, allocatable, save :: GMTR_A_var_pl(:,:,:,:)
contains
